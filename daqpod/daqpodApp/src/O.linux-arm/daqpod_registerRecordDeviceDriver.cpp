...
/* Generated from ../O.Common/daqpod.dbd */
...
int daqpod_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/pi/epics/ioc/daqpod";
...
/* daqpod_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"daqpod_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(daqpod_registerRecordDeviceDriver(*iocshPpdbbase));
}
